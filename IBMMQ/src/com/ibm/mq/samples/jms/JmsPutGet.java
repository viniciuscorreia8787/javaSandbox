...
public class JmsPutGet {
	...
	private static final String HOST = "192.168.0.10"; // Host name or IP address
	...
	public static String putMessage (String messageToPut) {
		...
		try {
			...
			long uniqueNumber = System.currentTimeMillis() % 1000;
			TextMessage message = context.createTextMessage(messageToPut);
